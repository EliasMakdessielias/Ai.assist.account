...
export function kundPayload(form) {
  return {
    ...
    lev_landskod: t(form.lev_landskod),
    lev_telefon: t(form.lev_telefon),
    lev_telefon2: t(form.lev_telefon2),
    lev_fax: t(form.lev_fax),
    sni: t(form.sni),
    cfar: t(form.cfar),
    butiks_id: t(form.butiks_id),
