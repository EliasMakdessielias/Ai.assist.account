...
export const ACCOUNTING_AUDIT_ACTIONS = {
  ...
  verificationCorrectionStarted: 'verification_correction_started',
  verificationReversalCreated: 'verification_reversal_created',
  verificationReplacementCreated: 'verification_replacement_created',
  verificationCorrected: 'verification_corrected',
